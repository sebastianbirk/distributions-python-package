...
class Binomial(Distribution):
    ...
    def __add__(self, other):
        ...
        binomial_added = Binomial()
        binomial_added.p = self.p
        binomial_added.n = self.n + other.n
        binomial_added.calculate_mean()
        binomial_added.calculate_stdev()
        
        return binomial_added
